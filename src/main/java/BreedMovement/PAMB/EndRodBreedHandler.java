...
import BreedMovement.NB.ScissorsNeuterHandler;
...
public class EndRodBreedHandler {
    ...
    public static void onEntityInteract(PlayerInteractEvent.EntityInteract event) {
        ...
        // 绝育动物不能催生
        if (BreedMovement.NB.ScissorsNeuterHandler.isNeutered(animal)) return;
        ...
        if (baby == null) {
            log.warn("[BreedMovement] Failed to create baby from end rod breed, target: {}",
                    animal.getType());
            return;
        ...
        log.info("[BreedMovement] End rod breed! Player {} used end rod on {} at {}, baby spawned: {}",
