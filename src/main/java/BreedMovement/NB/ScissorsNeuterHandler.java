 ...
 * 1. 消耗剪刀耐久
 * 2. 掉落 2 个鸡蛋
 * 3. 给动物打上 NBT 标记 "breedmovement:neutered" = true
...
public class ScissorsNeuterHandler {
     ...
     * NBT 标记键名
     */
    public static final String NEUTERED_TAG = "breedmovement:neutered";
    ...
    public static void onEntityInteract(PlayerInteractEvent.EntityInteract event) {
        ...
        log.info("[BreedMovement] Scissors neuter! Player {} used shears on {} at {}",
